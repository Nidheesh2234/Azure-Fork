...
import { Calendar, MapPin, Clock, Users, Utensils, Star, Bell, Plus, X } from 'lucide-react';
...
const UpcomingEventsDialog = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('toggle-upcoming-events', handleToggle);
    return () => window.removeEventListener('toggle-upcoming-events', handleToggle);
  }, []);
...
export default UpcomingEventsDialog;